...
function setShop(dom, callback) {
    $.ajax({
        url: "http://127.0.0.1:9090/api/getgsshop" + "?timestamp=" + new Date().getTime(),
...
function setArea(dom, callback) {
    $.ajax({
        url: "http://127.0.0.1:9090/api/getgsshoparea" + "?timestamp=" + new Date().getTime(),
        success: function(data) {
...
function setProductList(dom, data, callback) {
    $.ajax({
        url: "http://127.0.0.1:9090/api/getgsproduct" + "?timestamp=" + new Date().getTime(),
